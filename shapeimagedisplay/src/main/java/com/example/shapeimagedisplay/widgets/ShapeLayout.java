...
public class ShapeLayout extends RelativeLayout
{
    ...
    private void obtainAttributes(Context context, @Nullable AttributeSet attrs, int defStyleAttr)
    {
        TypedArray typedArray =
                context.obtainStyledAttributes(attrs, R.styleable.ShapeLayout, defStyleAttr, 0);

        try {

            mRadius = typedArray.getDimension(R.styleable.ShapeLayout_radius, 0);
            mLeftTopRadius = typedArray.getDimension(R.styleable.ShapeLayout_radius_left_top, 0);
            mLeftBottomRadius =
                    typedArray.getDimension(R.styleable.ShapeLayout_radius_left_bottom, 0);
            mRightTopRadius = typedArray.getDimension(R.styleable.ShapeLayout_radius_right_top, 0);
            mRightBottomRadius =
                    typedArray.getDimension(R.styleable.ShapeLayout_radius_right_bottom, 0);
            mBorderWidth = typedArray.getDimension(R.styleable.ShapeLayout_borderWidth, 0);
            mAsCircle = typedArray.getBoolean(R.styleable.ShapeLayout_asCircle, false);
            mBorderColor = typedArray.getColor(R.styleable.ShapeLayout_borderColor, Color.WHITE);
